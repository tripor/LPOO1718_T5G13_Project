...
public class HouseIcon extends Icon {
	...
	public HouseIcon(int posX,int posY,int width,int height, final LabelIcon label) {
		super(posX,posY,width,height);
		
		this.addCaptureListener(new ClickListener() {
            public void clicked(InputEvent event, float x, float y) {
                GameStage.singleton.getMouse().createMouse("house.png", HouseL.width, HouseL.height);
            }
